...
$idizmenjenog=isset($car['idvzl'])?$car['idvzl']:"";
...
?>
    ...
    <table  class="table table-striped table-sm table-dark mt-5">
     ...
     <?php  foreach($cars as $car){
        ...
        if($car['idvzl']==$idizmenjenog){
       ?>
         <tr style=background-color:orange;>
         <td><?php echo $car['imeproizvodjaca']  ?></td>
         <td><?php echo $car['model']  ?></td>
         <td><?php echo $car['godistevozila'] ?></td>
         <td><?php echo $car['kubikaza'] ?></td>
         <td><?php echo $car['cena'] ?></td>
         <td><?php echo $car['kategorija'] ?></td>
         <td><a href="routes.php?page=showeditcar&idvzl=<?php echo $car['idvzl'] ?>" class="btn btn-warning">Edit</a></td>
         <td><a href="routes.php?page=deletecar&idvzl=<?php echo $car['idvzl'] ?>" class="btn btn-danger">Delete</a></td>
        </tr>
